...
<head>
	...
	<title>Prova Tecnica - Adicionar Pessoa</title>
</head>
<body>
	...
	<div class="container">
		...
		<hr />
		<form class="form-horizontal" action="/mvc?logica=AdicionaPessoaLogica&pessoa=${pessoa}">
			<div class="row">
			...
			<div class="row">
				<div class="form-group col-md-6">
					<label>Nome:</label> 
					<input type="text" required="required" class="form-control" name="${pessoa.nome}">
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-6">
